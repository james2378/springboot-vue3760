<template>
	<div class="diy_details page_expert_information" id="expert_information_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_expert_information'>
							<div_expert_information :obj="obj"></div_expert_information>
						</div>
					</div>
				</div>
			</div>
...
<script>
	import div_expert_information from "@/components/diy/div_expert_information.vue";
	import mixin from "@/mixins/page.js";
	export default {
		mixins:[mixin],
		components:{
			div_expert_information
		},
		data(){
			return{
		...
		methods:{
			...
			get_collect(obj) {
				...
				var query = {
					...
					source_field: "expert_information_id",
					source_id: obj["expert_information_id"],
					user_id
				};
		 ...
		 /****
			...
			change_collect() {
				...
				var query = {
					source_table: "expert_information",
					source_field: "expert_information_id",
					source_id: this.obj["expert_information_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/expert_information/set?expert_information_id=' + _this.obj["expert_information_id"], {
								praise_len
							}, (res) => {
								if(res.result){
