...
const routes = [
	...
	// 期刊文章路由
	{
		path: '/journal_articles/table',
		name: 'journal_articles_table',
		component: () => import('../views/journal_articles/table.vue')
	},
	{
		path: '/journal_articles/view',
		name: 'journal_articles_view',
		component: () => import('../views/journal_articles/view.vue')
	},
	// 稿件管理路由
	{
		path: '/manuscript_management/table',
		name: 'manuscript_management_table',
		component: () => import('../views/manuscript_management/table.vue')
	},
	{
		path: '/manuscript_management/view',
		name: 'manuscript_management_view',
		component: () => import('../views/manuscript_management/view.vue')
	},
	// 稿件分类路由
	{
		path: '/manuscript_classification/table',
		name: 'manuscript_classification_table',
		component: () => import('../views/manuscript_classification/table.vue')
	},
	{
		path: '/manuscript_classification/view',
		name: 'manuscript_classification_view',
		component: () => import('../views/manuscript_classification/view.vue')
	},
	// 专家信息路由
	{
